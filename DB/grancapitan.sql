...
--
-- Servidor: db
-- Tiempo de generación: 19-12-2022 a las 18:31:23
...
(69, NULL, 'federico@iesgrancapitan.org', NULL, NULL, 'dpto-musica', 2),
(70, NULL, 'jralbendin@iesgrancapitan.org', NULL, NULL, 'dpto-informatica', 2),
(71, NULL, 'jalcazar@iesgrancapitan.org', NULL, NULL, 'dpto-matematicas', 2),
(72, NULL, 'anruser@iesgrancapitan.org', NULL, NULL, 'dpto-economia-fol', 2),
(73, NULL, 'isaantunez@iesgrancapitan.org', NULL, NULL, 'dpto-matematicas', 2),
(74, NULL, 'p19arsara@iesgrancapitan.org', NULL, NULL, 'dpto-hosteleria', 2),
(75, NULL, 'reginoarribas@iesgrancapitan.org', NULL, NULL, 'dpto-hosteleria', 2),
(76, NULL, 'abelper@iesgrancapitan.org', NULL, NULL, 'dpto-matematicas', 2),
(77, 'Chaves', NULL, 3354132, '2ºGSDAWA', NULL, 3),
(78, 'Cebrián', NULL, 2293874, '2ºGSDAWA', NULL, 3),
(79, 'Mariscal', NULL, 752252, '2ºGSDAWA', NULL, 3),
(80, 'Virginia', NULL, 8392050, '2ºGSDAWA', NULL, 3),
(81, 'Joaquin', NULL, 1701755, '2ºGSASIRA', NULL, 3),
(82, 'Alberto', NULL, 2289789, '2ºGSASIRA', NULL, 3),
(83, 'Sandra', NULL, 8392054, '2ºGSASIRA', NULL, 3),
(84, 'Manuel', NULL, 3093004, '2ºGSDAWA', NULL, 3),
(85, 'Miguel', NULL, 1468733, '2ºGSASIRA', NULL, 3),
(86, 'Rafa', NULL, 1606639, '2ºGSASIRA', NULL, 3);
...
--
ALTER TABLE `usuarios`
  MODIFY `idUsuario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT de la tabla `usuarios_tarjetas`
--
ALTER TABLE `usuarios_tarjetas`
  MODIFY `idUserTarje` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
