    ...
    <div id='divcentral' class='container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center'>
        <div class='d-flex justify-content-center'>
            <div id='divcentral2' class='text-center'>
                ...
                <form method='post' onsubmit="confirmar(event)" id="comienzoCurso" action=index.php?controller=usuario&action=importar>
                    <input type="hidden" name="borrar" id="borrar">
                    <input type="submit" class='btn btn-primary mb-3' value="ComienzoCurso">
                </form>
