        ...
        <div id='divcentral2' class='text-center'>
            <form method='post' action="index.php?controller=tarjeta&action=setTarjeta">
                    ...
                    <table class="table border border-dark">
                        ...
                        <tbody>
                            <?php foreach ($controller->listado as $valueD) {
                                echo "<tr><td>";
                                if (null == $valueD[3]) {
                                    echo "<input type='radio' name='usuario' value=" .($valueD[4] == 2 || $valueD[4] == 1 ? $valueD[1] : $valueD[2]) . "_" . $valueD[0] . ">";
                                }
                                echo "</td>";
                ...
                <div class="mt-3">
                    ...
                    <a class='btn btn-primary' href='index.php?controller=tarjeta&action=<?php echo ($valueD[4] == 2 || $valueD[4] == 1 ? 'getDepart' : 'getUnidad') ?>'>Volver</a>
